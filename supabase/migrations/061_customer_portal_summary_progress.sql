-- Phase 10 · Add checkpoint progress to customer portal summary.
-- Customer portal milestones show per-milestone completion percentage,
-- matching the per-project portal (get_customer_portal).
